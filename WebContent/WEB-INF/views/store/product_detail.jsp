...
<script src="${root }javascript/store/product_detail.js" defer></script>
...
<body>
	...
	<section class="product-category">
		<nav class="category-nav">
			<ol class="product-category-breadcrumb">
				<li class="entry">
					<a class="link" href="">패브릭</a>
				</li>
				<li class="entry">
					<a class="link" href="">커튼/블라인드</a>
				</li>
			</ol>
		</nav>
	</section>
		...
		<div class="row">
			<div class="product-carousel-wrap col-12 col-md-6 col-lg-7">
				<div class="carousel-list-entry">
					...
					<ul class="carousel-list__list">
						<li class="carousel-list-btn">
							<span class="carousel-paginator"></span>
						</li>
						<li class="carousel-list-btn">
							<span class="carousel-paginator"></span>
						</li>
			...
			<div class="overview__content col-12 col-md-6 col-lg-5">
				<div class="header">
						...
						<div class="icon-group">
							<button class="icon-wrap scrab">
								<svg class="icon--stroke" aria-label="스크랩" width="24" height="24" fill="currentColor" stroke="currentColor" stroke-width="0.5" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet">
									<path d="M11.53 18.54l-8.06 4.31A1 1 0 0 1 2 21.97V3.5A1.5 1.5 0 0 1 3.5 2h17A1.5 1.5 0 0 1 22 3.5v18.47a1 1 0 0 1-1.47.88l-8.06-4.31a1 1 0 0 0-.94 0z"></path></svg>
					...
					<div>
						<span class="discount">${productInfo.product_discount_rate }%</span>
						<span class="discount price">${productInfo.product_price }원</span>
					</div>
					...
					<button class="coupon">
						...
						<div class="coupon-right">
							<svg class="icon" aria-label="다운로드" width="30" height="30" fill="none" preserveAspectRatio="xMidYMid meet">
								...
								<path d="M17.5 13.5h3.333L15 19.333 9.167 13.5H12.5v-5h5v5zM9.167 22.667V21h11.666v1.667H9.167z" fill="#35C5F0"></path></svg>
						</div>
					</button>
					<div class="info-wrap">
							...
							<div class="info-group">
								...
								<span class="info-other">
									<svg class="check-icon" width="10" height="9" fill="none" preserveAspectRatio="xMidYMid meet">
										<path d="M1 3.83l2.153 3.03a1 1 0 001.627.005L9 1" stroke="#BDBDBD" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
									제주도/도서산간 지역 5,000원
								</span>
							</div>
						</div>
						<div class="info__seller">
							<svg class="icon" width="24" height="24" fill="none" preserveAspectRatio="xMidYMid meet">
		...
		<div class="product-desc-wrap">
			...
			<section class="product-selling">
								...
								<div class="star-icon">
									<span>
										<svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
											...
											<use clip-path="url(#star-clip-0)" xlink:href="#star-path-0"></use></svg>
										<svg fill="#35C5F0" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
											<defs>
											<path id="star-path-0" d="M11.9996 19.7201L6.32294 22.1251C5.5626 22.4472 5.005 22.0311 5.0755 21.2188L5.60855 15.0767L1.5671 10.421C1.02579 9.79745 1.24924 9.13855 2.04358 8.95458L8.04973 7.56354L11.2287 2.28121C11.6545 1.57369 12.3502 1.5826 12.7706 2.28121L15.9496 7.56354L21.9557 8.95458C22.7602 9.1409 22.9667 9.8053 22.4322 10.421L18.3907 15.0767L18.9238 21.2188C18.9952 22.0414 18.4271 22.4432 17.6764 22.1251L11.9996 19.7201Z"></path>
											<clipPath id="star-clip-0">
					...
					<div class="user-review-wrap">
						<article class="user-review-container">
							...
							<div class="review-content-wrap">
								<div class="review-content-img" style="background-image: url(/image/items/curtain.jpg);"></div>
				...
				<div class="selling-paginator">
					<ol class="list">
						<li class="prev">
							<svg class="prev-icon" width="26" height="26" viewBox="0 0 26 26" preserveAspectRatio="xMidYMid meet">
				...
				<div class="selling-container">
					...
					<div>
						...
						<div class="question-content">
							<p class="content">5월 10일 주문번호 56831186 혹시 언제쯤 배송되는지 알 수 있을까요?</p>
						</div>
						<div class="question-answer">
							<div class="answer-wrap">
								...
								<p class="answer-content">안녕하세요. 누베스입니다. 고객님께서 문의주신 내용 답변드리겠습니다. 네 고객님 주문건 다음주 수~목 중 출고예정입니다. 좋은상품으로 빠르게 발송될 수 있도록 하겠습니다. 감사합니다. 더 궁금한 사항 있으시면 언제든지 문의해주세요. 항상 저희 누베스를 이용해 주셔서 감사합니다.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="product-selling">
				<div class="selling-container">
					...
					<div>
						...
						<p class="refund-note">반품 시 먼저 판매자와 연락하셔서 반품사유, 택배사, 배송비, 반품지 주소 등을 협의하신 후 반품상품을 발송해 주시기 바랍니다.</p>
						<ol class="refund-list">
							<li>구매자 단순 변심은 상품 수령 후 7일 이내 (구매자 반품배송비 부담)</li>
							<li>표시/광고와 상이, 상품하자의 경우 상품 수령 후 3개월 이내 혹은 표시/광고와 다른 사실을 안 날로부터 30일 이내. 둘 중 하나 경과 시 반품/교환 불가 (판매자 반품배송비 부담)</li>
						</ol>
					</div>
   ...
   //상품옵션1 선택 시 상품 옵션2 조회
	const option1 = document.querySelector('.option.option1'); //상단 옵션선택
