      ...
      <section class="main-container">
         ...
         <section class="main-container__left">
                           ...
                           <div class="input-wrap">
                              ...
                              <div class="input-binding">
                                 <div class="input-email">
                                    <input type="text" class="email"><span>@</span>
                                 </div>
                                 <select name="">
                  ...
                  <div class="order__input">
                     <form action="" method="POST">
                        ...
                        <div class="input-box">
                           ...
                           <div class="address-wrap">
                              <div class="line">
                                 ...
                                 <input class="zipcode" type="text" readonly="true">
                              </div>
                              <div class="line">
                        ...
                        <div class="input-box message-wrap">
                           <textarea class="message" name="" id="" maxlength="50" rows="1"
                              placeholder="배송 요청사항을 입력해주세요"></textarea>
                           <div class="text-limit">0/50</div>
                        </div>
                        <div class="input-box">
                           <select name="" class="select-message">
               ...
               <div class="order-info">
                  ...
                  <div class="order-content">
                     <div class="order-content__head">
                        ...
                        <div><span class="content-title grey">배송비 </span><span class="price">3000</span>원</div>
                     </div>
                     <div class="order-content__main">
                        ...
                        <div class="product-info">
                           ...
                           <p class="product-price-qty"><span class="content-title">0000</span><span class="qty">1</span>
                           </p>
                        </div>
                     </div>
                  </div>
            ...
            <section class="order-info__container point">
               ...
               <div class="input-box point">
                     ...
                     <div class="available-point">
                        사용 가능 포인트 <span class="point">0 </span>
                     </div>
                  </div>
            </section>
            <!--결제금액(992px 이하)-->
            ...
            <section class="pay-btn">
               <button class="button--color-skyblue">0000</button>
            </section>
         </section>
                     ...
                     <div class="terms__main">
                        <ul>
                           <li>
                              ...
                              <button>
                                 약관보기
                                 <svg class="arrow-right" fill="none" viewBox="0 0 16 10"
