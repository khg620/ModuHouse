...
<head>
   ...
   <link rel="stylesheet" href="${root }css/community/question.css">
   ...
   <script
	...
	<script src="${root }javascript/community/question.js" defer></script>
</head>
      ...
      <div class="article-container">
         ...
         <article class="question__content-article"> 
            ...
            <div class="content-wrap">
               ...
               <div class="content__image-wrap" style="background-image: url(${root}upload/${content.content_file })"></div>
            </div>
