...
<body>
   ...
   <button class="top-btn">
      <svg class="top-button__icon" width="45" height="45" viewBox="0 0 45 45" preserveAspectRatio="xMidYMid meet"><g fill="none" fill-rule="evenodd"><circle cx="22.5" cy="22.5" r="22.5" fill="#FEFFFE" fill-opacity="90%"></circle><path d="M12.5 12.5h20v20h-20z"></path><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 20l6.5-6 6.5 6m-6.5-5v15.999"></path></g></svg>
   </button>
