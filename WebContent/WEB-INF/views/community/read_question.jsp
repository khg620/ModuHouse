...
<body>
			...
			<div class="qna__container">
				...
				<main>
					<div class="content__body">
						<p class="content__text">${readContentBean.content_text }</p>
				...
				<footer class="content__footer">
					<ul class="content__keywords-list">
						<c:forEach var="keyword" items="${contentKeywordsBean }">
							<li class="keywords-item">
								<a href="" class="keywords-link">${contentKeywordsBean.keywords_item }</a>
							</li>
						</c:forEach>
					</ul>
					<button class="button--color-gray-inverted content__share" type="button">
						<svg class="content-share-icon" aria-label="공유하기" width="28" height="28" viewBox="0 0 28 28" preserveAspectRatio="xMidYMid meet">
					...
					<div class="content__metadata">
						...
						<span class="content-meta-info">
							조회
							<span class="content-meta-info"> ${readContentBean.read_count }</span>
						</span>
						<span class="content-meta-info">
							스크랩
							<span class="content-meta-info">${readContentBean.clip_count }</span>
						</span>
					</div>
				</footer>
			</div>
			...
			<section class="qna__comment">
				...
				<div class="qna__container">
					<h1 class="comment__header">
						댓글
						<span class="comment__cnt">${comment_cnt}</span>
					</h1>
									...
									<div class="comment__article-wrap">
										...
										<footer class="comment__metadata">
											...
											<span class="comment-meta-info like">
												<svg class="likes" width="15" height="14" preserveAspectRatio="xMidYMid meet" stroke="currentColor">
                                    <path fill-rule="evenodd" class="heart" d="M7 12.4c4.8-2.5 6.7-5.2 6.5-8-.3-3-4.1-4-6.1-1.4l-.4.5-.4-.5C4.6.4.8 1.5.6 4.4c-.3 2.8 1.6 5.5 6.4 8z">
                                    </path>
                                 </svg>
												좋아요
											</span>
					...
					<div class="sticky-comment-btn">
						<svg class="comment-share-icon" aria-label="공유하기" width="28" height="28" viewBox="0 0 28 28" preserveAspectRatio="xMidYMid meet">
                     <g fill="none" fill-rule="evenodd">
                        <g transform="translate(-124 -11)">
                           <path d="M124 11h28v28h-28z"></path>
                           <g stroke="#757575" transform="translate(126 12)">
	...
	<script>
	const edit_btn = document.querySelectorAll('.edit-btn-wrap > .edit-btn');
	
	edit_btn.forEach(x => x.addEventListener('click',(e)=> {
		console.log(e.target);
		console.log(edit_btn[0]);
