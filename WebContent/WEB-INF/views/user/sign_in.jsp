      ...
      <div class="sign-in-form-wrap">
         ...
         <section class="sign-in-form__sns">
            ...
            <div class="sign-in-form__button">
               <a href="">
                  <img src="../image/facebook.png" alt="login with facebook" class="facebook-sign">
               </a>
               <a href="">
                  <img src="../image/naver.png" alt="login with naver" class="naver-sign">
               </a>
               <a href="">
                  <img src="../image/kakao.png" alt="login with kakaotalk" class="kakao-sign">
               </a> 
            </div>
         </section>
         </div>
